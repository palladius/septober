...
## [2.4.05] - 2026-09-08
- Refactor: Migrated CHANGELOG.yml to standard Markdown format CHANGELOG.md (resolves #9).
...
## [1.5.4]
- Fixing Kasia bug (new user couldnt be created cos i removed email field :(
